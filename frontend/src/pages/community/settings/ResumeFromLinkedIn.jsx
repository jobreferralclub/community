...
const LinkedInExportGuide = () => {
  ...
  // Minimum height to make all cards uniform and match sidebar height
  ...
  return (
    <div className="w-full bg-gradient-to-br from-zinc-900 to-black border border-zinc-800 rounded-3xl p-8 shadow-2xl">
      <div className="grid md:grid-cols-2 gap-8 items-stretch">
        ...
        {/* Upload Card */}
        <div className={`bg-zinc-900/60 border border-zinc-800 rounded-2xl p-6 flex flex-col items-center text-center shadow-lg ${CARD_MIN_HEIGHT}`}>
          <label
          ...
          >
            ...
            <span className="text-sm text-gray-400">
              Accepted format: <strong>PDF</strong>
            </span>
